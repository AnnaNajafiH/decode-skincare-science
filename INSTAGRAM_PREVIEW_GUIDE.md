# 🎨 How to Create and View Instagram Posts - User Guide

## ✨ NEW Feature: Live Instagram Post Preview!

You can now **generate content** and **preview it as an actual Instagram post** with interactive features!
...
1. In the dropdown menu, select one of the trending topics:
   ...
   - **Gentle Retinol Alternatives** (RISING ⬆️ - Score: 82)
...
3. You'll see:
   - 4-5 carousel slides with scientific facts
   - A Gen Z-friendly caption
...
2. A full Instagram-style post appears with:
   ...
   - **Realistic header** - @beiersdorf_official profile
   - **Like button** - click to like (turns red ❤️)
   - **Comment & Share buttons** - Instagram UI
   - **Bookmark button** - click to save
   - **Like counter** - shows 2,847+ likes
   - **Full caption** with your generated text
   - **Clickable hashtags** in blue
...
- **Read the caption**: See your AI-generated text with hashtags
- **Close preview**: Click the "✕ Close Preview" button or click outside
...
- Slide 4: "TEWL reduced by 34% = moisture stays locked in 🔒"
- Slide 5: "Want that glow? Science has your back 🔬"

**Caption**: "The real tea on glass skin ☕✨ It's not just hype—hyaluronic acid is backed by clinical trials..."

**Hashtags**: #GlassSkin #SkincareScience #HyaluronicAcid #BeiersdorfResearch #Skincare
...
- Slide 4: "Texture improvement? Clinical studies say YES ✅"

**Caption**: "Niacinamide isn't a trend—it's proven science 💯 Our research shows real results..."

**Hashtags**: #Niacinamide #PoreCare #SkincareScience #SkinTexture #Beiersdorf
...
- Slide 4: "Pro tip: Layer OVER your moisturizer 📝"

**Caption**: "Slugging sounds weird but the science is SOLID 🐌🔬 Our studies prove occlusives lock in moisture..."

**Hashtags**: #Slugging #SkinBarrier #Skincare101 #SkincareScience #Beiersdorf
...
- Slide 4: "Same anti-aging power, zero irritation ✨"

**Caption**: "Looking for gentle anti-aging? Science says bakuchiol delivers 💚 Our clinical trials show comparable results..."

**Hashtags**: #Bakuchiol #RetinolAlternative #GentleSkincare #AntiAging #Beiersdorf
...
- **Clean layout** matching Instagram's native interface
...
- ✅ **Real engagement metrics** (2,847 likes, "Just now")
- ✅ **Slide counter** showing progress (1/5, 2/5, etc.)
...
4. **Check the confidence score** (higher = better quality)
...
- **Hashtags are strategic** - mix trending tags with branded terms
...
4. Screenshot or share the preview with designers
5. Use visual hints to brief design team
...
6. **Close**: Click outside or "✕ Close Preview"
...
- ✅ **Visually descriptive**: Hints for designers included
...
- **3 visual hints** for designers
- **2 R&D references** for credibility
...
**Navigate to**: Content Generator (top menu)

**Generate your first post** and see how AI transforms science into scroll-stopping Instagram content! 🚀
...
- **Explore**: All 5 sections of the app for complete workflow

**Enjoy creating science-backed content!** ✨
